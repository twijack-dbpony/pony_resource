                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="x_panel">
                                <div class="x_content">
                                    ...
                                    @endif
                                    <form data-parsley-validate class="form-horizontal form-label-left" action="{{route('manesix_pppe')}}" method="post" enctype="multipart/form-data">
                                        {{csrf_field()}}
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                ...
                                                <input type="hidden" name="fail_image_url" value="{{$ponypost->water_img}}">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <div id="type" class="btn-group">
                                                    <input type="radio" class="flat" name="type" value="bulletin"
                                                           @if(old('type') == 'bulletin' || $ponypost->type == 'bulletin')
                                                                checked="checked"
                                                           @endif
                                                    >
                                                    ...
                                                    <input type="radio" class="flat" name="type" value="resource"
                                                           @if(old('type') == 'resource' || $ponypost->type == 'resource')
                                                                checked="checked"
                                                           @endif
                                                    >
                                                    ...
                                                    <input type="radio" class="flat" name="type" value="chat"
                                                           @if(old('type') == 'chat' || $ponypost->type == 'chat')
                                                                checked="checked"
                                                           @endif
                                                    >
                                                    ...
                                                    <input type="radio" class="flat" name="type" value="original"
                                                           @if(old('type') == 'original' || $ponypost->type == 'original')
                                                                checked="checked"
                                                           @endif
                                                    >
                                        ...
                                        <div class="form-group">
                                            <label>文章内容</label>
                                            <textarea id="textbox" name="content" style="width: 100%; height: 100%;">{{old('content') ? : $ponypost->content}}</textarea>
                                        </div>
                                        <div class="ln_solid"></div>
                                        <div class="form-group">
                                            <button type="submit" class="btn btn-success" style="margin-top: 10px">完成编辑</button>
                                        </div>
                                    </form>
                                </div>
                            </div>
