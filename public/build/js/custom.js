	...
	/* CROPPER */
	   ...
	   /* DATERANGEPICKER */
		...
		function init_daterangepicker() {
            ...
            var start_date_moment=new Date(date_calendar_array[0]);
            var end_date_moment=new Date(date_calendar_array[1]);

			var optionSet1 = {
			  startDate: start_date_moment,
			  endDate: end_date_moment,
			  minDate: '01/01/2010',
			  maxDate: '12/31/2020',
			  dateLimit: {
				days: 60
