...
(function($) {
	...
	var DanmuPlayer = function(element, options) {
		...
		$(element).append('<video id="danmu_video" class="video-js vjs-default-skin" width="' + options.width + '" height="' + options.height + '"><source id="bullets" src="' + options.src + '" type="video/mp4" /></video>');
		danmu_video = videojs("#danmu_video", {
			...
			function initer() {
				...
				this.on('pause', function(e) {
                    ...
                    console.log(parseInt(danmu_video.currentTime() * 10));
			...
			$(".vjs-control-bar").append('<span class="shezhi " id="danmu_send_opt">Pony Power!!!</span>');
			...
			$(".vjs-control-bar").append('<span  class="shezhi  vjs-menu-button" id="danmu_shi_opt"  > 弹幕设置 </span>');
